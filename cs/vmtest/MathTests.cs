...
public class MathTests
{
    ...
    public void TestSIGADD()
    {
        ...
        vm.Execute(new Bytecode[] {
            ...
            Bytecode.CONST, (Bytecode)6,
            Bytecode.CONST, (Bytecode)4,
            Bytecode.SIGADD,
        });

        Assert.AreEqual(1, vm.Stack.Length);
        Assert.AreEqual(28, vm.Stack[0]);
    }
    [TestMethod]
    public void TestSUB()
    {
    ...
    public void TestSIGMUL()
    {
        ...
        Assert.AreEqual(1, vm.Stack.Length);
        Assert.AreEqual(900, vm.Stack[0]);
    }
    [TestMethod]
    public void TestDIV()
    {
